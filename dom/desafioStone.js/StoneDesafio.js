...
// Teste de Estresse=========================================================================================
for(let i = 1; i <= 1;i++){
    lista[i]=new produto(`Cadeira${i}`,5,(11*100))
}
...
// Teste Produtos Diferentes repeticao de emails
// for(let i = 1; i <= 3;i++){
...
function divisaoDePrecos(lista,bancoDeClientes){
...
const dicionario = divisaoDePrecos(lista,bancoDeClientes)
console.log(dicionario.get('cliente1@Stone.com'));
console.log(dicionario.get('cliente3@Stone.com'));
